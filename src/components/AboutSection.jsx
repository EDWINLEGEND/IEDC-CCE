...
const AboutSection = () => {
    return (
        <div className="about-wrapper" id="about" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
            <CardSection>
                ...
                <div className="bento-grid-about">
                    ...
                    <div className="bento-card vision-card v-card-1">
                        <h4 style={{ fontSize: '1.8rem', fontWeight: '600', color: 'white', marginBottom: '1rem' }}>Knowledge & Skills</h4>
                        <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.95rem', lineHeight: '1.6' }}>
                            Strengthen entrepreneurial quality and motivation to develop knowledge and skills among members.
                        </p>
                    </div>

                    <div className="bento-card vision-card v-card-2">
                        <h4 style={{ fontSize: '1.8rem', fontWeight: '600', color: 'white', marginBottom: '1rem' }}>Profitable Projects</h4>
                        <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.95rem', lineHeight: '1.6' }}>
                            Impart basic managerial knowledge to help students formulate effective, innovative projects.
                        </p>
                    </div>
                </div>
            </CardSection>
